<meta charset="utf-8">
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo e(asset('template/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')); ?>">
  <!-- iCheck for checkboxes and radio inputs -->
  <link rel="stylesheet" href="<?php echo e(asset('template/plugins/iCheck/all.css')); ?>">
  <!-- Theme style -->
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="<?php echo e(asset('css/google-fonts.css')); ?>"><?php /**PATH C:\wamp64\www\erapor\resources\views/layout/includes/head-table.blade.php ENDPATH**/ ?>